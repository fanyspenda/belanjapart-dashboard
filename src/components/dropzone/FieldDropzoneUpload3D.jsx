  ...
  data ? (
    <div className="dropzone-holder-image">
      ...
      <div className="dropzone-holder-label">
        <p className="text-muted">Update 3D max 10mb</p>
      </div>
    </div>
  ) : (
...
class FieldDropzoneUpload3D extends Component {
  componentDidUpdate() {
  ...
  handleDrop = files => {
    ...
    formData.append('is_three_d', true);
...
export default connect(mapStateToProps, { createPdf })(FieldDropzoneUpload3D);
