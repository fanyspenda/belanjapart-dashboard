...
import { fetchData } from '@actions/fileLibrary.action';
...
class FileLibrary extends React.Component {
  ...
  handleClick = () => {
    const { limit, page, selected } = this.state;
      ...
      <div className="content-wrapper">
        <div className="row my-4">
          <div className="col-md-4">
            <h4 className="font-weight-bold">FILE LIBRARY</h4>
          </div>
...
export default connect(mapStateToProps, { fetchData })(FileLibrary);
